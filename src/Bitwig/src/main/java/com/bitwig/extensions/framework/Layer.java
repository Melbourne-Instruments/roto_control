...
/**
 * A layer defines a number of bindings between a source object and a target
 * that should be active when the layer is active. A layer on tap will override
 * bindings from a lower layer.
 */
public class Layer {
    ...
    public AbsoluteHardwareControlBinding bind(final AbsoluteHardwareControl source,
    ...
    public RelativeHardwareControlToRangedValueBinding bind(final RelativeHardwareControl source,
        final SettableRangedValue target) {
        final RelativeHardwareControlToRangedValueBinding binding =
            new RelativeHardwareControlToRangedValueBinding(source, target);
    ...
    public RelativeHardwareControlBinding bind(final RelativeHardwareControl source,
        final HardwareActionBindable stepBackwardsAction, final HardwareActionBindable stepForwardsAction) {
    ...
    public Binding<?, ?> bind(final Object actionOwner, final HardwareAction source,
    ...
    public Binding<?, ?> bind(final Object actionOwner, final HardwareAction source, final Runnable target) {
        return bind(actionOwner, source, getLayers().getControllerExtension().getHost().createAction(target, null));
    }
    ...
    /**
     * Binds pressing of the supplied button to toggling of the target. If the
     * button has an on/off light it will also reflect the value of the target.
     */
    ...
    public void bindToggle(final HardwareButton button, final Runnable pressedRunnable,
        final BooleanSupplier isLightOnOffSupplier) {
        bindPressed(button, pressedRunnable);
        bind(isLightOnOffSupplier, button);
    }
    
    public void bindToggle(final HardwareButton button, final HardwareActionBindable pressedAction,
        final BooleanSupplier isLightOnOffSupplier) {
    ...
    public Binding<?, ?> bindLightState(final Supplier<InternalHardwareLightState> supplier,
